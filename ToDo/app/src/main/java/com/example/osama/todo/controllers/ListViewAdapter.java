package com.example.osama.todo.controllers;
...
import com.example.osama.todo.R;
...
class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (status.get(position) == 0) {
            holder.statusView.setImageResource(R.drawable.task_incomplete_thumsup);
        } else {
            holder.statusView.setImageResource(R.drawable.task_copmlete_thumsup);
        }
